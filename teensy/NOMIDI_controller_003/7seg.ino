void updateAllSegments() {
  digitalWrite(SEG_K[lastSegmentPos], LOW);
  digitalWrite(SEG_K[segmentPos % segmentMax], HIGH);
  setSegment(segmentData[segmentPos % segmentMax], 8);
...
void setBits(int a, int b, int c, int d, int e, int f, int g, int dp, int s) {
  ...
  switch (s)  {
    case 0: digitalWrite(SEG[0], a); break;
    case 1: digitalWrite(SEG[1], b); break;
    case 2: digitalWrite(SEG[2], c); break;
    case 3: digitalWrite(SEG[3], d); break;
    case 4: digitalWrite(SEG[4], e); break;
    case 5: digitalWrite(SEG[5], f); break;
    case 6: digitalWrite(SEG[6], g); break;
    case 7: digitalWrite(SEG[7], dp); break;
    case 8:
